...
<body id="reportsPage">
                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-overflow">
                        ...
                        <div class="tm-notification-items">
                            <div class="media tm-notification-item">
                                <div class="tm-gray-circle"><img src="<?= $assets . 'vendor/templatemo_524_product_admin/' ?>img/notification-01.jpg" alt="Avatar Image" class="rounded-circle"></div>
                            ...
                            <div class="media tm-notification-item">
                                <div class="tm-gray-circle"><img src="<?= $assets . 'vendor/templatemo_524_product_admin/' ?>img/notification-02.jpg" alt="Avatar Image" class="rounded-circle"></div>
                                <div class="media-body">
                            ...
                            <div class="media tm-notification-item">
                                <div class="tm-gray-circle"><img src="<?= $assets . 'vendor/templatemo_524_product_admin/' ?>img/notification-03.jpg" alt="Avatar Image" class="rounded-circle"></div>
                                <div class="media-body">
    ...
    <script src="<?= $assets . 'vendor/templatemo_524_product_admin/' ?>js/moment.min.js"></script>
    <!-- https://momentjs.com/ -->
    <script src="<?= $assets . 'vendor/templatemo_524_product_admin/' ?>js/Chart.min.js"></script>
    <!-- http://www.chartjs.org/docs/latest/ -->
    <script src="<?= $assets . 'vendor/templatemo_524_product_admin/' ?>js/bootstrap.min.js"></script>
    <!-- https://getbootstrap.com/ -->
    <script src="<?= $assets . 'vendor/templatemo_524_product_admin/' ?>js/tooplate-scripts.js"></script>
    <script>
